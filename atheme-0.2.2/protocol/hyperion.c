 ...
 *
 * $Id: hyperion.c 902 2005-07-17 02:26:34Z alambert $
 */
...
static uint8_t hyperion_server_login(void)
{
        ...
        sts("CAPAB :QS KLN UNKLN QU DNCR SRV CHW");
...
/* PRIVMSG wrapper */
static void hyperion_msg(char *target, char *fmt, ...)
{
        va_list ap;
        char buf[BUFSIZE];
