 ...
 *
 * $Id: inspircd.c 4885 2006-03-03 16:03:08Z jilles $
 */

#include "atheme.h"
#include "protocol/inspircd.h"

DECLARE_MODULE_V1("protocol/inspircd", TRUE, _modinit, NULL, "$Id: inspircd.c 4885 2006-03-03 16:03:08Z jilles $", "InspIRCd Core Team <http://www.inspircd.org/>");
