 ...
 *
 * $Id: ptlink.c 4885 2006-03-03 16:03:08Z jilles $
 */

#include "atheme.h"
#include "protocol/ptlink.h"

DECLARE_MODULE_V1("protocol/ptlink", TRUE, _modinit, NULL, "$Id: ptlink.c 4885 2006-03-03 16:03:08Z jilles $", "Atheme Development Group <http://www.atheme.org>");
