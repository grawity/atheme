 ...
 *
 * $Id: sorcery.c 4885 2006-03-03 16:03:08Z jilles $
 */

#include "atheme.h"
#include "protocol/sorcery.h"

DECLARE_MODULE_V1("protocol/sorcery", TRUE, _modinit, NULL, "$Id: sorcery.c 4885 2006-03-03 16:03:08Z jilles $", "Atheme Development Group <http://www.atheme.org>");
